...
#endif
static const char *ng0 = "D:/CECS341/lab2/LEGv8.v";
...
LAB15:    xsi_set_current_line(36, ng0);
    ...
    t3 = (t0 + 1368U);
    t7 = *((char **)t3);
    xsi_vlog_unsigned_less(t58, 64, t4, 64, t7, 64);
    memset(t57, 0, 8);
    t3 = (t58 + 4);
    t11 = *((unsigned int *)t3);
    t12 = (~(t11));
...
LAB41:    if (*((unsigned int *)t57) > 0)
        goto LAB42;

LAB43:    memcpy(t10, t15, 16);

LAB44:    t21 = (t0 + 1928);
    xsi_vlogvar_wait_assign_value(t21, t10, 0, 0, 64, 0LL);
    goto LAB19;
...
LAB50:    xsi_vlogtype_unsigned_bit_neg(t10, 64, t58, 64);
    t37 = (t0 + 1928);
    xsi_vlogvar_wait_assign_value(t37, t10, 0, 0, 64, 0LL);
    goto LAB19;
...
LAB40:    xsi_vlog_unsigned_bit_combine(t10, 64, t14, 64, t15, 64);
    goto LAB44;

LAB42:    memcpy(t10, t14, 16);
    goto LAB44;
...
extern void work_m_00000000001449802435_3717951388_init()
{
	...
	xsi_register_didat("work_m_00000000001449802435_3717951388", "isim/LEGv8_isim_beh.exe.sim/work/m_00000000001449802435_3717951388.didat");
